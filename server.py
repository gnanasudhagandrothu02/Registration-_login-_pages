...
def Create_database(): 
    ...
    cursor.execute("""CREATE TABLE IF NOT EXISTS users(id integer primary key autoincrement,fullname text not null,username TEXT UNIQUE NOT NULL,password TEXT NOT NULL)""")
    #commit query
    connection.commit()
    #close connection
    connection.close()
